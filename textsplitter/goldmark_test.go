...
func TestGoldMark(t *testing.T) {
	...
	markdown, expectedChunks := getGoldmarkTestMarkdownAndExpectedChunks()
...
func getGoldmarkTestMarkdownAndExpectedChunks() (string, []Chunk) {
	type meta = map[string]any

	expectedGoldmarkTestMarkdownChunks := []Chunk{
		{
	...
	return goldmarkTestMarkdown, expectedGoldmarkTestMarkdownChunks
}
